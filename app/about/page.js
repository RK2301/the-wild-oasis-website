...
async function page() {
    ...
    return (
        <div className="grid grid-cols-5 gap-x-20 gap-y-32 text-lg items-center pb-4">
            <div className="col-span-5 md:col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <p>
                        Our {cabinsNumber} luxury cabins provide a cozy base, but the real freedom and
            ...
            <div className="col-span-5 md:col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        <a
                            href="/cabins"
                            className="inline-block mt-4 bg-accent-500 px-8 py-5 text-primary-800 text-lg font-semibold rounded-md hover:bg-accent-600 transition-all"
                        >
